...
<head>
    ...
    @vite(['resources/css/info_user.css'])
</head>
                ...
                <div class="info-box">
                    ...
                    <div class="user-selector-container">
                        <select class="user-dropdown"
                            onchange="location.href='{{ route('info.user', '') }}/' + this.value">
                            @foreach($users ?? [] as $u)
                    ...
                    <div class="info-actions">
                        <button class="edit-btn"
                            onclick="alert('Funcionalitat no disponible en preview')">Editar</button>
                        <p class="back-link-wrapper">
                            <a href="{{ route('control.usuaris') }}" class="back-pill">
                                < Tornar enrere</a>
                        </p>
                    </div>
                </div>
